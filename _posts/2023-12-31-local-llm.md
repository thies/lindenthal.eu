...
Local spell checks with LLaVA work well. But the model runs rather slowly, even on my strong laptop. Putting this chatbot onto a Raspberry Pi is out of reach, I suppose. Also, it's not well-integrated into my workflow, yet (manual copy and paste, for now).
